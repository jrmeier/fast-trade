# Why is this in Fast Trade?

This is a fork of the [FinTA](https://github.com/peerchemist/finta) library. It is used to calculate technical indicators for backtesting. The original developer has stopped working on it and I find it incredibly useful, so thank you @PeerChemist!
